...
const dictionaries: Record<Language, Translations> = {
  vi: {
    ...
    creator_generate: "Tạo Mockup thông minh",
    rendering: "Đang xử lý...",
    generating_ai: "Đang dựng hình bằng AI...",
    generating_cloud: "Đang kết nối Cloud GPU...",
    download_mockup: "Tải Mockup",
    start_new: "Tạo mới",
    err_bg_required: "Vui lòng cung cấp ảnh nền",
    err_creative_required: "Vui lòng cung cấp ảnh thiết kế",
    err_no_bg: "Không tìm thấy ảnh nền",
    no_bg_image: "Không tìm thấy ảnh nền",
    creator_saving: "Đang lưu kết quả...",
    stage_uploading: "Đang tải dữ liệu...",
    stage_rendering: "Đang xử lý hình ảnh...",
  ...
  en: {
    ...
    creator_generate: "AI Smart Generation",
    rendering: "Processing...",
    generating_ai: "AI Smart Rendering...",
    generating_cloud: "Connected to Cloud GPU...",
    ...
    err_no_bg: "Background image not found",
    no_bg_image: "Background image not found",
    creator_saving: "Saving result...",
    stage_uploading: "Uploading assets...",
    stage_rendering: "Rendering image...",
